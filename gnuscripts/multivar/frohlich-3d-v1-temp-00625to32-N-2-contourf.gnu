...
prefix = "../../plots/multivar/frohlich-3d-v1-temp-00625to32-N-2-contourf"

# Set the titles
set xlabel "α" offset 0,0.8
set ylabel "Temperature (ħω₀/kB)" offset -0.5,0
set cblabel "v₁ (ω₀), N = 2" offset 1,0
...
splot '../../data/frohlich/variational/multivar/frohlich-3d-multivariate-v1-alpha-0to12-temp-00625to32-N-2.dat' nonuniform matrix notitle
