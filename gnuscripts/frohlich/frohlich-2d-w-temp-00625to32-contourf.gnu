...
prefix = "../../plots/frohlich/frohlich-2d-w-temp-00625to32-contourf"

# Set the titles
set xlabel "α" offset 0,0.8
set ylabel "Temperature (ħω₀/kB)" offset -0.5,0
set cblabel "Frohlich w (ω₀)" offset 1.5,0
...
splot '../../data/frohlich/variational/model/frohlich-2d-w-alpha-0to12-temp-00625to32.dat' matrix nonuniform notitle
