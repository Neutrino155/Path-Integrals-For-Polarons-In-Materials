...
prefix = "../../plots/highthroughput/general/general-alpha-energy-zpr-ratio"
...
conduction_file = "../../data/frohlich/variational/general/frohlich-materials-general-conduction.txt"
valence_file = "../../data/frohlich/variational/general/frohlich-materials-general-valence.txt"
...
plot    "conduction_other_groups_output.txt" using 11:(-($19 - $16) / $19 * 100.0) w points pt 6 lc rgb '#984EA3' t 'Other', \
        "conduction_group_15_output.txt" using 11:(-($19 - $16) / $19 * 100.0) w points pt 6 lc rgb '#4DAF4A' t '15', \
        "conduction_group_16_output.txt" using 11:(-($19 - $16) / $19 * 100.0) w points pt 6 lc rgb '#FF7F00' t '16', \
        "conduction_group_17_output.txt" using 11:(-($19 - $16) / $19 * 100.0) w points pt 6 lc rgb '#377EB8' t '17', \
        "valence_other_groups_output.txt" using 11:(-($19 - $16) / $19 * 100.0) w points pt 4 lc rgb '#984EA3' notitle, \
        "valence_group_15_output.txt" using 11:(-($19 - $16) / $19 * 100.0) w points pt 4 lc rgb '#4DAF4A' notitle, \
        "valence_group_16_output.txt" using 11:(-($19 - $16) / $19 * 100.0) w points pt 4 lc rgb '#FF7F00' notitle, \
        "valence_group_17_output.txt" using 11:(-($19 - $16) / $19 * 100.0) w points pt 4 lc rgb '#377EB8' notitle, \
