...
prefix = "../../plots/highthroughput/standard/standard-alpha-energy-zpr-ratio"
set key bottom right
set grid
set xlabel  "α"
set ylabel  "Percentage Energy Difference (%)"
set logscale xy

set yrange [1e-4:1e4]
set xrange [1e-3:1e3]

set for [i=-4:4] ytics (sprintf("10^{%d}", i) 10**i)
...
conduction_file = "../../data/frohlich/variational/standard/frohlich-materials-standard-conduction.txt"
valence_file = "../../data/frohlich/variational/standard/frohlich-materials-standard-valence.txt"
...
plot    "conduction_other_groups_output.txt" using 11:(-($18 - $16) / $18 * 100.0) w points pt 6 lc rgb '#984EA3' t 'Other', \
        "conduction_group_15_output.txt" using 11:(-($18 - $16) / $18 * 100.0) w points pt 6 lc rgb '#4DAF4A' t '15', \
        "conduction_group_16_output.txt" using 11:(-($18 - $16) / $18 * 100.0) w points pt 6 lc rgb '#FF7F00' t '16', \
        "conduction_group_17_output.txt" using 11:(-($18 - $16) / $18 * 100.0) w points pt 6 lc rgb '#377EB8' t '17', \
        "valence_other_groups_output.txt" using 11:(-($18 - $16) / $18 * 100.0) w points pt 4 lc rgb '#984EA3' notitle, \
        "valence_group_15_output.txt" using 11:(-($18 - $16) / $18 * 100.0) w points pt 4 lc rgb '#4DAF4A' notitle, \
        "valence_group_16_output.txt" using 11:(-($18 - $16) / $18 * 100.0) w points pt 4 lc rgb '#FF7F00' notitle, \
        "valence_group_17_output.txt" using 11:(-($18 - $16) / $18 * 100.0) w points pt 4 lc rgb '#377EB8' notitle, \
