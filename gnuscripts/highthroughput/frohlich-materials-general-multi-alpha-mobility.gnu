...
prefix = "../../plots/highthroughput/general/general-multi-alpha-mobility"
set key Left left bottom
set grid
set xlabel  "α"
set ylabel  "Polaron Mobility (cm²V⁻¹s⁻¹)"
set logscale xy
set yrange [1e-6:1e6]
set xrange [1e-3:1e3]

set for [i=-6:6:2] ytics (sprintf("10^{%d}", i) 10**i)
...
conduction_file = "../../data/frohlich/variational/general/frohlich-materials-general-multi-conduction.txt"
valence_file = "../../data/frohlich/variational/general/frohlich-materials-general-multi-valence.txt"
...
plot    "conduction_other_groups_output.txt" using 11:21 w points pt 6 lc rgb '#984EA3' t 'Other', \
        "conduction_group_15_output.txt" using 11:21 w points pt 6 lc rgb '#4DAF4A' t '15', \
        "conduction_group_16_output.txt" using 11:21 w points pt 6 lc rgb '#FF7F00' t '16', \
        "conduction_group_17_output.txt" using 11:21 w points pt 6 lc rgb '#377EB8' t '17', \
        "valence_other_groups_output.txt" using 11:21 w points pt 4 lc rgb '#984EA3' notitle, \
        "valence_group_15_output.txt" using 11:21 w points pt 4 lc rgb '#4DAF4A' notitle, \
        "valence_group_16_output.txt" using 11:21 w points pt 4 lc rgb '#FF7F00' notitle, \
        "valence_group_17_output.txt" using 11:21 w points pt 4 lc rgb '#377EB8' notitle, \
