...
prefix = "../../plots/highthroughput/general/general-alpha-energy"
...
system(sprintf("awk '$5 ~ /%s/ {print}' %s > %s", 'single', conduction_file, 'conduction_group_single_output.txt'))
system(sprintf("awk '$5 ~ /%s/ {print}' %s > %s", 'single', valence_file, 'conduction_group_single_output.txt'))
