...
prefix = "../../plots/highthroughput/feynman/feynman-alpha-mobility"
...
plot    "conduction_other_groups_output.txt" using 11:20 w points pt 6 lc rgb '#984EA3' t 'Other', \
        ...
        "valence_other_groups_output.txt" using 11:19 w points pt 4 lc rgb '#984EA3' notitle, \
        "valence_group_15_output.txt" using 11:19 w points pt 4 lc rgb '#4DAF4A' notitle, \
        "valence_group_16_output.txt" using 11:19 w points pt 4 lc rgb '#FF7F00' notitle, \
        "valence_group_17_output.txt" using 11:19 w points pt 4 lc rgb '#377EB8' notitle, \
