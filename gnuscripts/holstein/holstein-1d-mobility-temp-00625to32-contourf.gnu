...
prefix = "../../plots/holstein/holstein-1d-mobility-temp-00625to32-contourf"
...
set cbrange [*:1e6]
set for [i=-1:6] cbtics (sprintf("10^{%d}", i) 10**i)
...
splot '../../data/holstein/variational/model/holstein-1d-mobility-alpha-0to12-temp-00625to32.dat' nonuniform matrix notitle
