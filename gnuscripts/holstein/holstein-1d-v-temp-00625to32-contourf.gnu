...
prefix = "../../plots/holstein/holstein-1d-v-temp-00625to32-contourf"

# Set the titles
set xlabel "α" offset 0,0.8
set ylabel "Temperature (ħω₀/kB)" offset -0.5,0
set cblabel "Holstein v (ω₀)" offset 1.5,0
...
splot '../../data/holstein/variational/model/holstein-1d-v-alpha-0to12-temp-00625to32.dat' matrix nonuniform notitle
