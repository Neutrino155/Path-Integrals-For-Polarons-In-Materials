...
prefix = "../../plots/holstein/holstein-3d-radius-alpha-0to12-omega-01to2-contourf"

# Set the titles
set xlabel "α" offset 0,0.8
set ylabel "Phonon Frequency (ω₀)" offset -0.5,0
set cblabel "Holstein Mass (m₀)" offset -0.2,0
...
input_file = '../../data/holstein/variational/model/holstein-3d-radius-alpha-0to12-beta-inf.dat'
