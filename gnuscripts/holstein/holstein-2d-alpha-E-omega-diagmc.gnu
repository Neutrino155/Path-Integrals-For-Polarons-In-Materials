...
plot    "../../data/holstein/variational/model/holstein-2d-E-alpha-0to12-omega-0to2-beta-inf.dat" u 1:2 w l t "γ=0.1", \
        ...
        "../../data/holstein/diagmc/holstein_2d_parabolic_energy_alpha_0to5_gamma_01.txt" u 1:2:3 with yerrorbars notitle, \
