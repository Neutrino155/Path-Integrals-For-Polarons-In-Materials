...
\definecolor{ThesisLghtGrey}  {HTML} {ededed}
...
\begin{tikzpicture}
  \node[anchor=center]{\pgfornament[color=ImperialBlue,width=\titleornwidth]{88}};
\end{tikzpicture}}
...
\begin{tcolorbox}[colback=ThesisLghtGrey,colframe=ThesisDarkGrey, sharp corners]
  #1
\end{tcolorbox}}

% --- Coloured boxes for equations
\newtcolorbox{empheq}[2][]{colback=ThesisLghtGrey,
 colframe=ThesisDarkGrey,
 width=\textwidth,
 top=3pt, % default value 2mm
 bottom=3pt,
 title={#2},
